        ...
        <div className="flex justify-between items-center max-w-4xl">
          <div className="flex justify-center items-center">
            <div className="flex justify-start items-center">
              <div className="flex flex-col justify-center text-foreground text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-5 font-sans font-bold">
                AI Workspace
              </div>
            </div>
          ...
          <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3 ml-6">
            <button
            ...
            >
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  >
                    Intelligent context-aware reasoning by AI Workspace
                  </motion.div>
                  <motion.div
                    variants={itemVariants}
                  ...
                  >
                    Streamline your research and coding process with persistent context and seamless automation.
                  </motion.div>
                </div>
              </div>
              ...
              >
                <Link href="/login" passHref>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="h-10 sm:h-11 md:h-12 px-6 sm:px-8 md:px-10 lg:px-12 sm:py-[6px] relative bg-primary shadow-[0px_0px_0px_2.5px_rgba(255,255,255,0.08)_inset] overflow-hidden rounded-full flex justify-center items-center hover:bg-primary/90 transition-colors group cursor-pointer"
                  >
...
function OrbCanvas() {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uAccentA: { value: new THREE.Color("#808080") },
      uAccentB: { value: new THREE.Color("#4d4d4d") },
      uAccentC: { value: new THREE.Color("#bfbfbf") },
    }),
    []
  )
